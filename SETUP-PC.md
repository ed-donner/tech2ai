...
- Navigate to the "project root directory" by entering something like `cd C:\Users\YourUsername\Documents\Projects\tech2ai` using the actual path to your tech2ai project root directory. Do a `dir` and check you can see subdirectories for each week of the course.
...
- In the Anaconda Prompt, from within the `tech2ai` folder, type: `jupyter lab`
...
2. Navigate to the "project root directory" by entering something like `cd C:\Users\YourUsername\Documents\Projects\tech2ai` using the actual path to your tech2ai project root directory. Do a `dir` and check you can see subdirectories for each week of the course.  

Then, create a new virtual environment with this command:  
`python -m venv tech2ai`

3. Activate the virtual environment with  
`tech2ai\Scripts\activate`
...
...and Jupyter Lab should open up, ready for you to get started. Open the `intro` folder and double click on `joke.ipynb`. Success! Now close down jupyter lab and move on to Part 3.
...
And optionally you'll be using the terrific Weights & Biases at https://wandb.ai to watch over your training batches. Accounts are also free, and you can set up a token in a similar way.
...
3. Go to File > Save As. In the "Save as type" dropdown, select All Files. In the "File name" field, type exactly **.env** as the filename. Choose to save this in the project root directory (the folder called `tech2ai`) and click Save.
...
- Activate your environment with `conda activate tech2ai` if you used Anaconda or `tech2ai\Scripts\activate` if you used the alternative approach in Part 2B

- You should see (tech2ai) in your prompt which is your sign that all is well. And now, type: `jupyter lab` and Jupyter Lab should open up, ready for you to get started. Open the `segment1` folder and double click on `lab1.ipynb`. 
