...
`git clone https://github.com/ed-donner/tech2ai`

This creates a new directory `tech2ai` within your Projects folder and downloads the code for the class. Do `cd tech2ai` to go into it. This `tech2ai` directory is known as the "project root directory".
...
- Navigate to the "project root directory" using `cd ~/Documents/Projects/tech2ai` (replace this path as needed with the actual path to the tech2ai directory, your locally cloned version of the repo). Do `ls` and check you can see subdirectories for each week of the course.
...
- You have now built an isolated, dedicated AI environment for engineering LLMs, running vector datastores, and so much more! You now need to **activate** it using this command: `conda activate tech2ai`  

You should see `(tech2ai)` in your prompt, which indicates you've activated your new environment.

3. **Start Jupyter Lab:**

- In the Terminal window, from within the `tech2ai` folder, type: `jupyter lab`
...
2. Navigate to the "project root directory" using `cd ~/Documents/Projects/tech2ai` (replace this path with the actual path to the tech2ai directory, your locally cloned version of the repo). Do `ls` and check you can see subdirectories for each week of the course.  

Then, create a new virtual environment with this command:  
`python -m venv tech2ai`

3. Activate the virtual environment with  
`source tech2ai/bin/activate`
You should see (tech2ai) in your command prompt, which is your sign that things are going well.
...
From within the `tech2ai` folder, type: `jupyter lab`  
...and Jupyter Lab should open up, ready for you to get started. Open the `segment1` folder and double click on `lab1.ipynb`. Success! Now close down jupyter lab and move on to Part 3.
...
Optionally: we will also set up keys for Anthropic and Google:  
- Claude API at https://console.anthropic.com/ from Anthropic  
- Gemini API at https://ai.google.dev/gemini-api from Google  

You'll also be using the fabulous HuggingFace platform; an account is available for free at https://huggingface.co - you can create an API token from the Avatar menu >> Settings >> Access Tokens.

And optionally you can use the terrific Weights & Biases at https://wandb.ai to watch over your training batches. Accounts are also free, and you can set up a token in a similar way.
...
2. Navigate to the "project root directory" using `cd ~/Documents/Projects/tech2ai` (replace this path with the actual path to the tech2ai directory, your locally cloned version of the repo).
...
- Navigate to the "project root directory" using `cd ~/Documents/Projects/tech2ai` (replace this path with the actual path to the tech2ai directory, your locally cloned version of the repo). Do `ls` and check you can see subdirectories for each week of the course.  

- Activate your environment with `conda activate tech2ai` (or `source tech2ai/bin/activate` if you used the alternative approach in Part 2B)

- You should see (tech2ai) in your prompt which is your sign that all is well. And now, type: `jupyter lab` and Jupyter Lab should open up, ready for you to get started. Open the `intro` folder and double click on `joke.ipynb`.

And you're off to the races!

Note that any time you start jupyter lab in the future, you'll need to follow these Part 5 instructions to start it from within the `tech2ai` directory with the `tech2ai` environment activated.
...
If you have any problems, I've included a notebook called [troubleshooting.ipynb](troubleshooting.ipynb) to figure it out.
